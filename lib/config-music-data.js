...
const GENERATOR_OCTAVE_RANGES = {
    Bass:          { min: 28, max: 47 },
    Pad:           { min: 48, max: 64 },
    Melody:        { min: 64, max: 81 },  // E4–A5 (upper register)
    Vocal:         { min: 52, max: 67 },  // E3–G4 (lower register, no overlap with Melody)
    Countermelody: { min: 67, max: 83 },
    Texture:       { min: 72, max: 88 },
    Drones:        { min: 36, max: 52 },
    Ornament:      { min: 64, max: 80 },
    Miasmatic:     { min: 55, max: 74 },
    Arpeggio:      { min: 52, max: 76 },
    GlitchFx:      { min: 48, max: 84 },
};
...
const INSTRUMENT_MAP = {
    'Pad':           { program: 89,  channel: 1 },  // 89: Pad 2 (warm)
    'Melody':        { program: 80,  channel: 1 },  // 80: Lead 1 (square)
    'Vocal':         { program: 54,  channel: 1 },  // 54: Synth Voice
    'Bass':          { program: 33,  channel: 1 },  // 33: Electric Bass (finger)
    'Countermelody': { program: 6,   channel: 1 },  // 6: Harpsichord
    'Texture':       { program: 99,  channel: 1 },  // 99: Pad 4 (choir)
    'Ornament':      { program: 45,  channel: 1 },  // 45: Pizzicato Strings
    'Miasmatic':     { program: 81,  channel: 1 },  // 81: Lead 2 (sawtooth)
    'Drones':        { program: 95,  channel: 1 },  // 95: Pad 8 (sweep)
    'GlitchFx':      { program: 103, channel: 1 },  // 103: FX 8 (sci-fi)
    'Arpeggio':      { program: 98,  channel: 1 },  // 98: FX 3 (crystal)

    // Channel 10 reserved for drums/percussion
    'Drums':         { program: 0,   channel: 10 },
    'Percussion':    { program: 0,   channel: 10 }
};
