...
function humanizeTiming(startTick, strength = 5) {
    const deviation = Math.floor((Math.random() * 2 - 1) * strength);
    return Math.max(0, startTick + deviation);
}

function clampToRange(pitch, min, max) {
